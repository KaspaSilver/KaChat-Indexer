...
async fn main() -> Result<()> {
    ...
    info!("Starting kachat-database-cleaner v{}", env!("CARGO_PKG_VERSION"));
    ...
    info!("kachat-database-cleaner started successfully");
    info!(
    ...
    info!("kachat-database-cleaner shutting down");
    Ok(())
}
